...
type ModalType = 'add-tx' | 'transfer' | 'deposit-detail' | 'account-detail' | 'account-edit' | 'create-account' | 'create-deposit' | 'categories' | 'all-transactions' | 'transaction-detail' | null
