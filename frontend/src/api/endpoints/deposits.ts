...
import type { DepositResponse, CreateDepositRequest, UpdateDepositRequest } from '../types'
...
export const depositsApi = {
  ...
  update: (id: string, data: UpdateDepositRequest) => api.put<DepositResponse>(`/api/v1/deposits/${id}`, data).then(r => r.data),
